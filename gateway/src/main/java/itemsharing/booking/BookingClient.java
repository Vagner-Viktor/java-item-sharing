...
import itemsharing.booking.dto.BookItemRequestDto;
import itemsharing.booking.dto.BookingState;
...
public class BookingClient extends BaseClient {
    ...
    @Autowired
    public BookingClient(@Value("${item-sharing-server.url}") String serverUrl, RestTemplateBuilder builder) {
        super(
                builder
